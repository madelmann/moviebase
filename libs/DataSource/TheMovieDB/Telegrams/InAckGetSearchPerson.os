...
public object InAckGetSearchPerson extends IncomingTelegram {
	...
	public void Constructor() {
		base.Constructor( TelegramMethod.GET, InAckGetSearchPerson.getIdentifier() );

		Items = new Vector<SearchItem>();
	}

	public static string getIdentifier() const {
		return "InAckGetSearchPerson";
	}
