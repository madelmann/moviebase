...
public object InAckGetSearchTVShow extends IncomingTelegram {
	...
	public void Constructor() {
		base.Constructor( TelegramMethod.GET, InAckGetSearchTVShow.getIdentifier() );

		Items = new Vector<SearchItem>();
	}

	public static string getIdentifier() const {
		return "InAckGetSearchTVShow";
	}
